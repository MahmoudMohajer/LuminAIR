use super::{assert_close, assert_close_rem, random_vec_rng};
use crate::graph::LuminairGraph;
use crate::StwoCompiler;
use crate::{binary_test, binary_test_no_broadcast, binary_test_rem, unary_test};
...
binary_test_rem!(|a, b| a % b, test_rem, f32, true);
